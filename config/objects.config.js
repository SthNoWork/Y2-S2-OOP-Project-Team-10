...
window.ObjectConfig = {
  ...
  placeableTypes: {
    ...
    whitePlank: {
      scale: 10, color: 0xe8dcc8, useImage: true,
      imageKey: 'block_atlas', startFrame: 'whitewood',
      physics: { friction: 0.75, restitution: 0.25, frictionAir: 0.01, label: 'building', mass: 7 },
      health: 25, onDeath: 'remove', maxCount: 5,
    },

    leaf: {
      scale: 10, color: 0x228b22, useImage: true,
    ...
    dirt: {
      scale: 10, color: 0x8b5e3c, useImage: true,
    ...
    grass: {
      scale: 10, color: 0x4a7c3f, useImage: true,
    ...
    sand: {
      scale: 10, color: 0xd2b55b, useImage: true,
    ...
    gravel: {
      scale: 10, color: 0x9e9e9e, useImage: true,
    ...
    wall: {
      scale: 10, color: 0x696969, useImage: true,
    ...
    stone: {
      scale: 10, color: 0x808080, useImage: true,
    ...
    sandstone: {
      scale: 10, color: 0xe0c97f, useImage: true,
    ...
    snow: {
      scale: 10, color: 0xe8f4f8, useImage: true,
    ...
    ice: {
      scale: 10, color: 0xa8d8ea, useImage: true,
    ...
    thickIce: {
      scale: 10, color: 0x78bcd4, useImage: true,
      imageKey: 'block_atlas', startFrame: 'ice1',
    ...
    coal: {
      scale: 10, color: 0x2d2d2d, useImage: true,
    ...
    iron: {
      scale: 10, color: 0xd8c0a0, useImage: true,
    ...
    gold: {
      scale: 10, color: 0xffd700, useImage: true,
    ...
    diamond: {
      scale: 10, color: 0x00e5ff, useImage: true,
    ...
    obsidian: {
      scale: 10, color: 0x1a0a2e, useImage: true,
    ...
    tnt: {
      scale: 10, color: 0xff2222, useImage: true,
  ...
  levelTypes: {
    ...
    bomb_crate: {
      scale: 5, color: 0xa0522d, useImage: true, imageKey: 'bomb_crate',
  ...
  internalTypes: {
    ...
    bomb: {
      scale: 3, color: 0x333333, useImage: true,
      imageKey: 'plane_atlas', startFrame: 'row11_04',
      physics: {
    ...
    player: {
      scale: 0.3, color: 0x00ff00, useImage: true, imageKey: 'player',
      physics: {
