// core/entities/mortar.js
// Mortar enemy entity that fires barrages.

class Mortar extends Attacker {
  ...
  shoot(target, options = {}) {
    ...
    let shotsFired = 0;
    const cfg = this.buildingConfig || window.ObjectConfig.internalTypes.mortar;
